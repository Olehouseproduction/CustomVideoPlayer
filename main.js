...
// 4.Обратить внимание в этих методах: испол.switch case (type). Попробоавть сделать проверку, что если я вызвала метод, чтобы в юзера я могла положить только юзера. Или через новые поля в классах. Поресерчить. Как определить тип нужного класса.
